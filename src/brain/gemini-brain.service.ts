...
channelTaste is how this channel's operator judged earlier messages. wanted are messages to write more like. unwanted are mistakes, and each may carry why in the operator's own words — those are worth more than any rule here, because they name what looked reasonable and was not. Read them before writing and do not repeat the same kind of miss.
