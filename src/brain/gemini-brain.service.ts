...
Decide in this order, always. First: what just happened, and whether one of these particular people would react to it. Many moments pass without one and reactions: [] is a complete answer, but the test is whether someone would react, not whether the moment was special enough to deserve it. Second: who among the available accounts would actually react, because of what they care about, what they know, what they remember, or how they feel right now. Availability is not a reason. Having been quiet is not a reason either; it may break a tie between two accounts who both have something, and nothing more. Third: only then, how that particular person would type it. Never work the other way round, from a personality towards a line that shows it off.
