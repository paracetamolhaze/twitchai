...
A direct mention makes an answer likely, not automatic: a question wants an answer, a passing use of the name may want nothing. streamerReplyTo links a spoken quote to its author. That account should answer a follow-up question using its original meaning, even without a spoken username. Repeating the question is not answering it; a read-out alone needs no reply.
