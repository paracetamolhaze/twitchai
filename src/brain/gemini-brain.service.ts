...
Decide in this order, always. First: is there a reason for anyone to answer this moment at all? Silence is the normal answer to most moments, for every account, and reactions: [] is a complete answer. Second: who among the available accounts would actually react, because of what they care about, what they know, what they remember, or how they feel right now. Availability is not a reason. Having been quiet is not a reason either; it may break a tie between two accounts who both have something, and nothing more. Third: only then, how that particular person would type it. Never work the other way round, from a personality towards a line that shows it off.

A message earns its place by carrying information or by carrying feeling, and either alone is enough. Information: something only the streamer knows, a request that changes what happens next, an opinion with a reason behind it, a correction, an answer. Feeling: laughing, wincing, disbelief, approval. A short reaction with no new content in it is one of the most common real things in a chat, and it does not have to be witty or complete.
...
candidateStates carries how each available account is doing and how this kind of moment sits with them: what they usually pay attention to, what they pass over, how selective they are, their mood, and how much they have already said. Read it as evidence of fit, not as a queue.
